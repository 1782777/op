...
class Example(QWidget):
    ...
    def linePlot(self):
        ...
        self.gridLayout.addWidget(plt1, 0, 1)

    def scatterPlot(self):
        plt2 = pg.PlotWidget()
        x = np.random.normal(size=1000)
        y = np.random.normal(size=1000)
        plt2.plot(x, y, pen=1, symbol="o")
        x = np.random.normal(size=1000)
        y = np.random.normal(size=1000)
        plt2.plot(x, y, pen='r', symbol="o",symbolBrush=(0,255,0))
        self.gridLayout.addWidget(plt2, 1, 2)
    ...
    def three_curves(self):
        ...
        self.gridLayout.addWidget(plt3, 3, 3)
